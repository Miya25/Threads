...
const UserProfileInfo: FC<IUserProfileInfo> = ({
  userProfileInfo,
  token,
  authenticatedUser,
  username,
  toggleFollowAndUnfollowHandler,
}) => {
    ...
    <div className="w-full flex flex-col gap-4 p-4 md:p-0">
      ...
      <div className="flex items-center justify-between w-full">
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-1">
            ...
            <p className="text-[.65rem] bg-[#36353560] text-[#989696] py-[.35rem] px-2 rounded-full font-light">
              threads.net
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-[#959494c9] text-sm truncate w-[80%]">
          ...
          {userProfileInfo?.link && <span>·</span>}{" "}
          {userProfileInfo?.link && (
          ...
          <div className="flex gap-4">
            {username === authenticatedUser?.username ? (
              <button
                ...
                onClick={() => dispatch(setToEditUserInfo(userProfileInfo))}
              >
                Edit Profile
              </button>
            ) : (

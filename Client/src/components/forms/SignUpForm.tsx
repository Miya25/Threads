...
const SignUpForm = (): JSX.Element => {
  ...
  const inputFieldStyle =
    "placeholder:text-[#726e6e] text-white block w-full border border-borderColor rounded-sm p-2 pr-10 shadow-sm focus:outline-none focus:border-non focus:ring-1 sm:text-sm bg-transparent";
  ...
  return (
    <>
      <form
        className="flex items-center justify-center flex-col gap-6 border  bg-matteBlack border-borderColor p-5 rounded-md w-[400px] mx-4"
        onSubmit={handleSubmit(handleSignUp)}
      >
        <h1 className="text-white font-semibold text-[1.5rem] self-start">
          <span className="font-light text-lightText">Join</span>{" "}
          <span className="gradient"> Threads </span>{" "}
          <span className="font-light text-lightText">today</span>
        </h1>
        <div className="flex justify-center flex-col gap-3 w-full">
          ...
          {errors.name && errors.name.type === "required" && (
            <p className={errorStyle}>Name is required</p>
          )}
          {errors.name && errors.name.type === "maxLength" && (
            <p className={errorStyle}>
              Username should not exceed to 30 characters
            </p>
          )}
          ...
          {errors.username && errors.username.type === "required" && (
            <p className={errorStyle}>Username is required</p>
          )}
          {errors.username && errors.username.type === "maxLength" && (
            <p className={errorStyle}>
              Username should not exceed to 15 characters
            </p>
          )}
          ...
          <div className="relative">
            ...
            {showPassword ? (
              <FiEye
                className="absolute top-0 bottom-0 right-3 my-auto text-lightText text-[1rem] cursor-pointer"
          ...
          {errors.confirmPassword &&
            errors.confirmPassword.type === "required" && (
              <p className={errorStyle}>Confirm password is required</p>
            )}
          {errors.confirmPassword && (
